...
namespace UltimaOnline.Ethics
{
    public abstract class Power
    {
        ...
        public virtual bool CheckInvoke(Player from)
        {
            ...
            {
                from.Mobile.LocalOverheadMessage(UltimaOnline.Network.MessageType.Regular, 0x3B2, false, "You lack the power to invoke this ability.");
                return false;
            }
