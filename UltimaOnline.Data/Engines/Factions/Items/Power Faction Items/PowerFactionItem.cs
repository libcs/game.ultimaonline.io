...
namespace UltimaOnline
{
    public abstract class PowerFactionItem : Item
    {
            ...
            protected override void OnTick()
            {
                if (_mobile.Alive)
                {
                    if (!_screamed)
                    {
                        ...
                        _mobile.PublicOverheadMessage(UltimaOnline.Network.MessageType.Regular, 2118, false, "Aaaaah!");
                    }
                            ...
                            if (weight < item.Weight)
                            {
                                ...
                                if (obj != null)
                                {
                                    ...
                                    killer.LocalOverheadMessage(
                                        UltimaOnline.Network.MessageType.Regular, 2119, false,
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            {
                from.LocalOverheadMessage(UltimaOnline.Network.MessageType.Regular, 2119, false, "The object vanishes from your hands as you touch it.");

                Timer.DelayCall(TimeSpan.FromSeconds(1.0), delegate ()
                {
                    from.LocalOverheadMessage(UltimaOnline.Network.MessageType.Regular, 2118, false, "You feel a strange tingling sensation throughout your body.");
                });

                Timer.DelayCall(TimeSpan.FromSeconds(4.0), delegate ()
                {
                    from.LocalOverheadMessage(UltimaOnline.Network.MessageType.Regular, 2118, false, "Your skin begins to burn.");
                });
