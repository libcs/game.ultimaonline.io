...
using System.Text;
using UltimaOnline.Engines.MLQuests.Objectives;
using UltimaOnline.Items;
using UltimaOnline.Engines.MLQuests.Rewards;
using UltimaOnline.Mobiles;

namespace UltimaOnline.Engines.MLQuests.Definitions
{
    public static class Spellweaving
    {
        public static void AwardTo(PlayerMobile pm)
        {
            ...
            if (!context.Spellweaving)
            {
                ...
                Effects.SendMovingParticles(new Entity(UltimaOnline.Serial.Zero, new Point3D(pm.X - 6, pm.Y - 6, pm.Z + 15), pm.Map), pm, 0x36D4, 7, 0, false, true, 9502, 1, 0, (EffectLayer)255, 0x100, 0x497, 0);
                Effects.SendMovingParticles(new Entity(UltimaOnline.Serial.Zero, new Point3D(pm.X - 4, pm.Y - 6, pm.Z + 15), pm.Map), pm, 0x36D4, 7, 0, false, true, 9502, 1, 0, (EffectLayer)255, 0x100, 0x497, 0);
                Effects.SendMovingParticles(new Entity(UltimaOnline.Serial.Zero, new Point3D(pm.X - 6, pm.Y - 4, pm.Z + 15), pm.Map), pm, 0x36D4, 7, 0, false, true, 9502, 1, 0, (EffectLayer)255, 0x100, 0x497, 0);

                Effects.SendTargetParticles(pm, 0x375A, 35, 90, 9502, (EffectLayer)255, 0x100, 0x00, 0x00);
            }
        }
    }
