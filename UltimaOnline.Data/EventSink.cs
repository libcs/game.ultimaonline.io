...
namespace UltimaOnline
{
    ...
    {
        public CreateGuildEventArgs(int id) => Id = id;
    ...
    {
        AggressiveActionEventArgs(Mobile aggressed, Mobile aggressor, bool criminal)
        {
            Aggressed = aggressed;
            Aggressor = aggressor;
            Criminal = criminal;
        ...
        static Queue<AggressiveActionEventArgs> _pool = new Queue<AggressiveActionEventArgs>();
        ...
        public static AggressiveActionEventArgs Create(Mobile aggressed, Mobile aggressor, bool criminal)
        {
            ...
            else args = new AggressiveActionEventArgs(aggressed, aggressor, criminal);
            return args;
        }

        public void Free() => _pool.Enqueue(this);
    }
    ...
    public class MovementEventArgs : EventArgs
    {
        ...
        static Queue<MovementEventArgs> _pool = new Queue<MovementEventArgs>();
        ...
        public static MovementEventArgs Create(Mobile mobile, Direction dir)
        {
            ...
            else args = new MovementEventArgs(mobile, dir);
            return args;
        }
    ...
    public class ServerListEventArgs : EventArgs
    {
        ...
        public void AddServer(string name, int fullPercent, TimeZoneInfo tz, IPEndPoint address) => Servers.Add(new ServerInfo(name, fullPercent, tz, address));
    }
    ...
    public static class EventSink
    {
		...
		*/
        ...
        public static void InvokeGuildGumpRequest(GuildGumpRequestArgs e) => GuildGumpRequest?.Invoke(e);
        ...
        public static void InvokeProfileRequest(ProfileRequestEventArgs e) => ProfileRequest?.Invoke(e);
        public static void InvokeChangeProfileRequest(ChangeProfileRequestEventArgs e) => ChangeProfileRequest?.Invoke(e);
        public static void InvokePaperdollRequest(PaperdollRequestEventArgs e) => PaperdollRequest?.Invoke(e);
        public static void InvokeAccountLogin(AccountLoginEventArgs e) => AccountLogin?.Invoke(e);
        public static void InvokeChatRequest(ChatRequestEventArgs e) => ChatRequest?.Invoke(e);
        ...
        public static void InvokeRenameRequest(RenameRequestEventArgs e) => RenameRequest?.Invoke(e);
        ...
        public static void InvokeDisconnected(DisconnectedEventArgs e) => Disconnected?.Invoke(e);
        public static void InvokeAnimateRequest(AnimateRequestEventArgs e) => AnimateRequest?.Invoke(e);
        public static void InvokeCastSpellRequest(CastSpellRequestEventArgs e) => CastSpellRequest?.Invoke(e);
        public static void InvokeBandageTargetRequest(BandageTargetRequestEventArgs e) => BandageTargetRequest?.Invoke(e);
        public static void InvokeOpenSpellbookRequest(OpenSpellbookRequestEventArgs e) => OpenSpellbookRequest?.Invoke(e);
        public static void InvokeDisarmRequest(DisarmRequestEventArgs e) => DisarmRequest?.Invoke(e);
        public static void InvokeStunRequest(StunRequestEventArgs e) => StunRequest?.Invoke(e);
        public static void InvokeHelpRequest(HelpRequestEventArgs e) => HelpRequest?.Invoke(e);
        ...
        public static void InvokeHungerChanged(HungerChangedEventArgs e) => HungerChanged?.Invoke(e);
        ...
        public static void InvokeLogin(LoginEventArgs e) => Login?.Invoke(e);
        ...
        public static void InvokeOpenDoorMacroUsed(OpenDoorMacroEventArgs e) => OpenDoorMacroUsed?.Invoke(e);
        public static void InvokeWorldLoad() => WorldLoad?.Invoke();
        public static void InvokeWorldSave(WorldSaveEventArgs e) => WorldSave?.Invoke(e);
