...
namespace UltimaOnline.Items
{
	public class Bola : Item
	{
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			else if (UltimaOnline.Spells.Ninjitsu.AnimalForm.UnderTransformation( from ) )
			{
		...
		private static void FinishThrow( object state )
		{
			...
			{
				if (UltimaOnline.Spells.Ninjitsu.AnimalForm.UnderTransformation(to))
				{
		...
		public class BolaTarget : Target
		{
			...
			protected override void OnTarget( Mobile from, object obj )
			{
				...
				if ( obj is Mobile )
				{
					...
					else if (!to.Mounted && !UltimaOnline.Spells.Ninjitsu.AnimalForm.UnderTransformation(to))
					{
