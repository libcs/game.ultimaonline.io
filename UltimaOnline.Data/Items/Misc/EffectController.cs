                ...
                case ECEffectType.Moving:
                    {
                        ...
                        Effects.SendMovingParticles(from, to, m_ItemID, m_Speed, m_Duration, m_FixedDirection, m_Explodes, m_ParticleEffect, m_ExplodeParticleEffect, m_ExplodeSound, m_EffectLayer, m_Unknown, m_Hue, m_RenderMode);
                        break;
                    }
                case ECEffectType.Target:
                    {
                        Effects.SendTargetParticles(from, m_ItemID, m_Speed, m_Duration, m_ParticleEffect, m_EffectLayer, m_Unknown, m_Hue, m_RenderMode);
                        break;
                    }
            }
        }
