	...
	public class PowerScroll : SpecialScroll
	{
		...
		*/
		...
		public PowerScroll( SkillName skill, double value ) : base( skill, value )
		{
			...
			if ( Value == 105.0 || skill == UltimaOnline.SkillName.Blacksmith || skill == UltimaOnline.SkillName.Tailoring )
		...
		public override void Use( Mobile from )
		{
			...
			Effects.SendMovingParticles( new Entity( Serial.Zero, new Point3D( from.X - 6, from.Y - 6, from.Z + 15 ), from.Map ), from, 0x36D4, 7, 0, false, true, 9502, 1, 0, (EffectLayer)255, 0x100, 0x497, 0);
			Effects.SendMovingParticles( new Entity( Serial.Zero, new Point3D( from.X - 4, from.Y - 6, from.Z + 15 ), from.Map ), from, 0x36D4, 7, 0, false, true, 9502, 1, 0, (EffectLayer)255, 0x100, 0x497, 0);
			Effects.SendMovingParticles( new Entity( Serial.Zero, new Point3D( from.X - 6, from.Y - 4, from.Z + 15 ), from.Map ), from, 0x36D4, 7, 0, false, true, 9502, 1, 0, (EffectLayer)255, 0x100, 0x497, 0);
