...
namespace UltimaOnline.Items
{
    public class ScrollofTranscendence : SpecialScroll
    {
        ...
        public override void Use(Mobile from)
        {
            ...
            Effects.SendTargetParticles(from, 0x373A, 35, 45, 9502, (EffectLayer)255, 0x100, 0x00, 0x00);
            Effects.SendTargetParticles(from, 0x376A, 35, 45, 9502, (EffectLayer)255, 0x100, 0x00, 0x00);
