...
namespace UltimaOnline
{
	...
	public sealed class HairEquipUpdate : Packet
	{
			...
			: base( 0x2E, 15 )
		{
			...
			_Stream.Write( (int)hairSerial );
			_Stream.Write( (short)parent.HairItemID );
			_Stream.Write( (byte)0 );
			_Stream.Write( (byte)Layer.Hair );
			_Stream.Write( (int)parent.Serial );
	...
	public sealed class FacialHairEquipUpdate : Packet
	{
			...
			: base( 0x2E, 15 )
		{
			...
			_Stream.Write( (int)hairSerial );
			_Stream.Write( (short)parent.FacialHairItemID );
			_Stream.Write( (byte)0 );
	...
	public sealed class RemoveHair : Packet
	{
		public RemoveHair( Mobile parent )
			: base( 0x1D, 5 )
		{
			_Stream.Write( (int)HairInfo.FakeSerial( parent ) );
		}
	}
	...
	public sealed class RemoveFacialHair : Packet
	{
		public RemoveFacialHair( Mobile parent )
			: base( 0x1D, 5 )
		{
			_Stream.Write( (int)FacialHairInfo.FakeSerial( parent ) );
		}
	}
}