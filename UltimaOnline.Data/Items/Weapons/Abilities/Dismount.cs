...
namespace UltimaOnline.Items
{
	...
	public class Dismount : WeaponAbility
	{
		...
		public override void OnHit( Mobile attacker, Mobile defender, int damage )
		{
			...
			if (mount == null && !UltimaOnline.Spells.Ninjitsu.AnimalForm.UnderTransformation( defender ) )
			{
			...
			{
				if (UltimaOnline.Spells.Ninjitsu.AnimalForm.UnderTransformation(defender))
				{
