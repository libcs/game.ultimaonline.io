	...
	public class RidingSwipe : WeaponAbility
	{
		...
		public override void OnHit( Mobile attacker, Mobile defender, int damage )
		{
			...
			else
			{
				...
				if(UltimaOnline.Items.ParalyzingBlow.IsImmune( defender ) )	//Does it still do damage?
				{
				...
				else
				{
                    ...
                    UltimaOnline.Items.ParalyzingBlow.BeginImmunity( defender, UltimaOnline.Items.ParalyzingBlow.FreezeDelayDuration );
				}
			}
		}
	}
