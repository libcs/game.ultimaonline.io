...
namespace UltimaOnline.Misc
{
    public class NotorietyHandlers
    {
        ...
        public static int MobileNotoriety(Mobile source, Mobile target)
        {
            ...
            {
                if (!target.Body.IsHuman && !target.Body.IsGhost && !IsPet(target as BaseCreature) && !(target is PlayerMobile) || !Core.ML && !target.CanBeginAction(typeof(UltimaOnline.Spells.Seventh.PolymorphSpell)))
                    return Notoriety.CanBeAttacked;
            }
