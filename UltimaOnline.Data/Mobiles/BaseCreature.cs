...
using UltimaOnline.SkillHandlers;
	...
	public partial class BaseCreature : Mobile, IHonorTarget, IQuestGiver
	{
		...
		*/
		...
		public virtual bool IsEnemy( Mobile m )
		{
			...
			if ( !(m is BaseCreature) || m is UltimaOnline.Engines.Quests.Haven.MilitiaFighter )
				return true;
		...
		public virtual double GetControlChance( Mobile m, bool useBaseSkill )
		{
			...
			if ( dMinTameSkill > -24.9 && UltimaOnline.SkillHandlers.AnimalTaming.CheckMastery( m, this ) )
				dMinTameSkill = -24.9;
