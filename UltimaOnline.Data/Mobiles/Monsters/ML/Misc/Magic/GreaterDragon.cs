...
namespace UltimaOnline.Mobiles
{
	...
	public class GreaterDragon : BaseCreature
	{
		...
		public override void Deserialize( GenericReader reader )
		{
			...
			if( version == 0 )
			{
                UltimaOnline.SkillHandlers.AnimalTaming.ScaleStats( this, 0.50 );
                UltimaOnline.SkillHandlers.AnimalTaming.ScaleSkills( this, 0.80, 0.90 ); // 90% * 80% = 72% of original skills trainable to 90%
