...
using UltimaOnline.Spells.Bushido;
...
using UltimaOnline.Engines.CannedEvil;
using UltimaOnline.Engines.Craft;
using UltimaOnline.Spells.Spellweaving;
...
namespace UltimaOnline.Mobiles
{
    ...
    public partial class PlayerMobile : Mobile, IHonorTarget
    {
		...
		*/
        ...
        public UltimaOnline.Guilds.RankDefinition GuildRank
        {
            get
            {
                if (this.AccessLevel >= AccessLevel.GameMaster)
                    return UltimaOnline.Guilds.RankDefinition.Leader;
                else
                    return m_GuildRank;
            }
        ...
        public override bool Move(Direction d)
        {
            ...
            if (!Alive)
                UltimaOnline.Movement.MovementImpl.IgnoreMovableImpassables = true;

            res = base.Move(d);

            UltimaOnline.Movement.MovementImpl.IgnoreMovableImpassables = false;
        ...
        {
            UltimaOnline.Engines.MLQuests.Gumps.BaseQuestGump.CloseOtherGumps(this);
            CloseGump(typeof(UltimaOnline.Engines.MLQuests.Gumps.QuestLogDetailedGump));
            CloseGump(typeof(UltimaOnline.Engines.MLQuests.Gumps.QuestLogGump));
            CloseGump(typeof(UltimaOnline.Engines.MLQuests.Gumps.QuestOfferGump));
        ...
        public override void OnDeath(Container c)
        {
            ...
            UltimaOnline.Guilds.Guild.HandleDeath(this, killer);
        ...
        public override bool NewGuildDisplay { get { return UltimaOnline.Guilds.Guild.NewGuildSystem; } }
        ...
        protected override bool OnMove(Direction d)
        {
            ...
            if (Hidden && DesignContext.Find(this) == null) //Hidden & NOT customizing a house
            {
                if (!Mounted && Skills.Stealth.Value >= 25.0)
                {
                    ...
                    {
                        UltimaOnline.SkillHandlers.Stealth.OnUse(this);
                    }
                }
                else
                {
        ...
        public override void OnGuildChange(UltimaOnline.Guilds.BaseGuild oldGuild)
        {
            InvalidateMyRunUO();
        }
