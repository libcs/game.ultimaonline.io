...
namespace UltimaOnline.Mobiles
{
	public class Thief : BaseVendor
	{
		...
		public override void InitOutfit()
		{
			...
			AddItem( new UltimaOnline.Items.Shirt( Utility.RandomNeutralHue() ) );
			AddItem( new UltimaOnline.Items.LongPants( Utility.RandomNeutralHue() ) );
			AddItem( new UltimaOnline.Items.Dagger() );
			AddItem( new UltimaOnline.Items.ThighBoots( Utility.RandomNeutralHue() ) );
		}
