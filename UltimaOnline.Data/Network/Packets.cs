...
namespace UltimaOnline.Network
{
    ...
    public sealed class DamagePacketOld : Packet
    {
        public DamagePacketOld(Mobile m, int amount) : base(0xBF)
        {
            ...
            _Stream.Write((short)0x22);
            _Stream.Write((byte)1);
            _Stream.Write((int)m.Serial);
    ...
    public sealed class SetArrow : Packet
    {
        ...
        {
            _Stream.Write((byte)1);
            _Stream.Write((short)x);
            _Stream.Write((short)y);
        }
    }
    ...
    public sealed class DisplaySecureTrade : Packet
    {
            ...
            : base(0x6F)
        {
            ...
            _Stream.Write((byte)0); // Display
            _Stream.Write(them.Serial);
            _Stream.Write(first.Serial);
            _Stream.Write(second.Serial);
            _Stream.Write(true);

            _Stream.WriteAsciiFixed(name, 30);
        }
    }
    ...
    public sealed class CloseSecureTrade : Packet
    {
            ...
            : base(0x6F)
        {
            ...
            _Stream.Write((byte)1); // Close
            _Stream.Write(cont.Serial);
        }
    }
    ...
    public sealed class UpdateSecureTrade : Packet
    {
            ...
            : base(0x6F)
        {
            ...
            _Stream.Write((byte)flag);
            _Stream.Write(cont.Serial);
            _Stream.Write(first);
            _Stream.Write(second);
        }
    }
    ...
    public sealed class SecureTradeEquip : Packet
    {
        ...
        {
            _Stream.Write((int)item.Serial);
            _Stream.Write((short)item.ItemID);
            _Stream.Write((byte)0);
            _Stream.Write((short)item.Amount);
            _Stream.Write((short)item.X);
            _Stream.Write((short)item.Y);
            _Stream.Write((int)m.Serial);
            _Stream.Write((short)item.Hue);
        }
    }
    ...
    public sealed class SecureTradeEquip6017 : Packet
    {
        public SecureTradeEquip6017(Item item, Mobile m) : base(0x25, 21)
        {
            ...
            _Stream.Write((short)item.X);
            _Stream.Write((short)item.Y);
            _Stream.Write((byte)0); // Grid Location?
            _Stream.Write((int)m.Serial);
            _Stream.Write((short)item.Hue);
        }
    }
    ...
    public sealed class MapPatches : Packet
    {
        public MapPatches() : base(0xBF)
        {
            ...
            _Stream.Write((short)0x0018);

            _Stream.Write((int)4);

            _Stream.Write((int)Map.Felucca.Tiles.Patch.StaticBlocks);
            _Stream.Write((int)Map.Felucca.Tiles.Patch.LandBlocks);

            _Stream.Write((int)Map.Trammel.Tiles.Patch.StaticBlocks);
            _Stream.Write((int)Map.Trammel.Tiles.Patch.LandBlocks);

            _Stream.Write((int)Map.Ilshenar.Tiles.Patch.StaticBlocks);
            _Stream.Write((int)Map.Ilshenar.Tiles.Patch.LandBlocks);

            _Stream.Write((int)Map.Malas.Tiles.Patch.StaticBlocks);
            _Stream.Write((int)Map.Malas.Tiles.Patch.LandBlocks);
        }
    }
    ...
    public sealed class ObjectHelpResponse : Packet
    {
        public ObjectHelpResponse(IEntity e, string text) : base(0xB7)
        {
            ...
            _Stream.Write((int)e.Serial);
            _Stream.WriteBigUniNull(text);
        }
    }
    ...
    public sealed class VendorBuyContent : Packet
    {
            ...
            : base(0x3c)
        {
            ...
            _Stream.Write((short)list.Count);
            ...
            for (int i = list.Count - 1; i >= 0; --i)
            {
                ...
                _Stream.Write((int)bis.MySerial);
                _Stream.Write((ushort)bis.ItemID);
                _Stream.Write((byte)0);//itemid offset
                _Stream.Write((ushort)bis.Amount);
                _Stream.Write((short)(i + 1));//x
                _Stream.Write((short)1);//y
                _Stream.Write((int)bis.ContainerSerial);
                _Stream.Write((ushort)bis.Hue);
            }
        }
    }
    ...
    public sealed class DisplayBuyList : Packet
    {
        ...
        {
            _Stream.Write((int)vendor.Serial);
            _Stream.Write((short)0x30); // buy window id?
        }
    }
    ...
    public sealed class VendorBuyList : Packet
    {
            ...
            : base(0x74)
        {
            ...
            _Stream.Write((int)(BuyPack == null ? Serial.MinusOne : BuyPack.Serial));

            _Stream.Write((byte)list.Count);

            for (int i = 0; i < list.Count; ++i)
            {
                BuyItemState bis = list[i];

                _Stream.Write((int)bis.Price);
                ...
                _Stream.Write((byte)(desc.Length + 1));
                _Stream.WriteAsciiNull(desc);
            }
        }
    }
    ...
    public sealed class VendorSellList : Packet
    {
        public VendorSellList(Mobile shopkeeper, ICollection<SellItemState> sis) : base(0x9E)
        {
            ...
            _Stream.Write((int)shopkeeper.Serial);

            _Stream.Write((ushort)sis.Count);

            foreach (SellItemState state in sis)
            {
                _Stream.Write((int)state.Item.Serial);
                _Stream.Write((ushort)state.Item.ItemID);
                _Stream.Write((ushort)state.Item.Hue);
                _Stream.Write((ushort)state.Item.Amount);
                _Stream.Write((ushort)state.Price);
                ...
                _Stream.Write((ushort)(name.Length));
                _Stream.WriteAsciiFixed(name, (ushort)(name.Length));
            }
        }
    }
    ...
    public sealed class DeathAnimation : Packet
    {
        ...
        {
            _Stream.Write((int)killed.Serial);
            _Stream.Write((int)(corpse == null ? Serial.Zero : corpse.Serial));
            _Stream.Write((int)0);
        }
    }
        ...
        public DisplayEquipmentInfo(Item item, EquipmentInfo info) : base(0xBF)
        {
            ...
            if (info.Crafter != null)
            {
                ...
                else
                {
                    ...
                    _Stream.WriteAsciiFixed(name, length);
                }
            }
            ...
            {
                _Stream.Write((int)attrs[i].Number);
                _Stream.Write((short)attrs[i].Charges);
            }
    ...
    public sealed class ChangeCombatant : Packet
    {
        ...
        {
            _Stream.Write(combatant != null ? combatant.Serial : Serial.Zero);
        }
    }
    ...
    public sealed class DisplayHuePicker : Packet
    {
        ...
        {
            _Stream.Write((int)huePicker.Serial);
            _Stream.Write((short)0);
            _Stream.Write((short)huePicker.ItemID);
        }
    }
    ...
    public sealed class TripTimeResponse : Packet
    {
        ...
        {
            _Stream.Write((byte)unk);
            _Stream.Write((int)Environment.TickCount);
        }
    }
    ...
    public sealed class UnicodePrompt : Packet
    {
        public UnicodePrompt(Prompt prompt) : base(0xC2)
        {
            ...
            _Stream.Write((int)prompt.Serial);
            _Stream.Write((int)prompt.Serial);
            _Stream.Write((int)0);
            _Stream.Write((int)0);
            _Stream.Write((short)0);
    ...
    public sealed class SpeedControl : Packet
    {
            ...
            : base(0xBF)
        {
            ...
            _Stream.Write((short)0x26);
            _Stream.Write((byte)speedControl);
        }
    }
    ...
    public sealed class BondedStatus : Packet
    {
        public BondedStatus(int val1, Serial serial, int val2) : base(0xBF)
        {
            ...
            _Stream.Write((short)0x19);
            _Stream.Write((byte)val1);
            _Stream.Write((int)serial);
            _Stream.Write((byte)val2);
        }
    }
    ...
    public sealed class ToggleSpecialAbility : Packet
    {
            ...
            : base(0xBF)
        {
            ...
            _Stream.Write((short)0x25);

            _Stream.Write((short)abilityID);
            _Stream.Write((bool)active);
        }
    }
    ...
    public sealed class DisplayItemListMenu : Packet
    {
        public DisplayItemListMenu(ItemListMenu menu) : base(0x7C)
        {
            ...
            _Stream.Write((int)((IMenu)menu).Serial);
            _Stream.Write((short)0);
            ...
            else
            {
                ...
                _Stream.Write((byte)questionLength);
                _Stream.WriteAsciiFixed(question, questionLength);
            }
            ...
            _Stream.Write((byte)entriesLength);

            for (int i = 0; i < entriesLength; ++i)
            {
                ItemListEntry e = entries[i];

                _Stream.Write((ushort)e.ItemID);
                _Stream.Write((short)e.Hue);
                ...
                else
                {
                    ...
                    _Stream.Write((byte)nameLength);
                    _Stream.WriteAsciiFixed(name, nameLength);
                }
            }
        }
    }
    ...
    public sealed class DisplayQuestionMenu : Packet
    {
        public DisplayQuestionMenu(QuestionMenu menu) : base(0x7C)
        {
            ...
            _Stream.Write((byte)answersLength);
            ...
            for (int i = 0; i < answersLength; ++i)
            {
                ...
                else
                {
                    ...
                    _Stream.Write((byte)answerLength);
                    _Stream.WriteAsciiFixed(answer, answerLength);
                }
            }
        }
    }
    ...
    public sealed class DisplayContextMenu : Packet
    {
        public DisplayContextMenu(ContextMenu menu) : base(0xBF)
        {
            ...
            _Stream.Write((short)0x14);
            _Stream.Write((short)0x02);

            IEntity target = menu.Target as IEntity;

            _Stream.Write((int)(target == null ? Serial.MinusOne : target.Serial));

            _Stream.Write((byte)length);
            ...
            for (int i = 0; i < length; ++i)
            {
                ...
                _Stream.Write((int)e.Number);
                _Stream.Write((short)i);
    ...
    public sealed class DisplayContextMenuOld : Packet
    {
        public DisplayContextMenuOld(ContextMenu menu) : base(0xBF)
        {
            ...
            for (int i = 0; i < length; ++i)
            {
                ...
                _Stream.Write((short)i);
                _Stream.Write((ushort)(e.Number - 3000000));
    ...
    public sealed class DisplayProfile : Packet
    {
        public DisplayProfile(bool realSerial, Mobile m, string header, string body, string footer) : base(0xB8)
        {
            ...
            _Stream.Write((int)(realSerial ? m.Serial : Serial.Zero));
            _Stream.WriteAsciiNull(header);
            _Stream.WriteBigUniNull(footer);
            _Stream.WriteBigUniNull(body);
        }
    }
    ...
    public sealed class CloseGump : Packet
    {
        public CloseGump(int typeID, int buttonID) : base(0xBF)
        {
            ...
            _Stream.Write((short)0x04);
            _Stream.Write((int)typeID);
            _Stream.Write((int)buttonID);
        }
    }
    ...
    public sealed class EquipUpdate : Packet
    {
        public EquipUpdate(Item item) : base(0x2E, 15)
        {
            ...
            _Stream.Write((short)item.ItemID);
            _Stream.Write((byte)0);
            _Stream.Write((byte)item.Layer);
            _Stream.Write((int)parentSerial);
            _Stream.Write((short)hue);
        }
    }
    ...
    public sealed class WorldItem : Packet
    {
        public WorldItem(Item item) : base(0x1A)
        {
            ...
            _Stream.Write((uint)serial);

            if (item is BaseMulti)
                _Stream.Write((short)(itemID | 0x4000));
            else
                _Stream.Write((short)itemID);

            if (amount != 0)
            {
                _Stream.Write((short)amount);
            }
            ...
            if (direction != 0)
                _Stream.Write((byte)direction);

            _Stream.Write((sbyte)loc.Z);

            if (hue != 0)
                _Stream.Write((ushort)hue);

            if (flags != 0)
                _Stream.Write((byte)flags);
        }
    }
    ...
    public sealed class WorldItemSA : Packet
    {
        public WorldItemSA(Item item) : base(0xF3, 24)
        {
            ...
            _Stream.Write((byte)item.Light);
            _Stream.Write((short)item.Hue);
            _Stream.Write((byte)item.GetPacketFlags());
        }
    }
    ...
    public sealed class Weather : Packet
    {
        ...
        {
            _Stream.Write((byte)v1);
            _Stream.Write((byte)v2);
            _Stream.Write((byte)v3);
        }
    }
    ...
    public sealed class UnkD3 : Packet
    {
        public UnkD3(Mobile beholder, Mobile beheld) : base(0xD3)
        {
            ...
            _Stream.Write((int)beheld.Serial);
            _Stream.Write((short)beheld.Body);
            _Stream.Write((short)beheld.X);
            _Stream.Write((short)beheld.Y);
            _Stream.Write((sbyte)beheld.Z);
            _Stream.Write((byte)beheld.Direction);
            _Stream.Write((ushort)beheld.Hue);
            _Stream.Write((byte)beheld.GetPacketFlags());
            _Stream.Write((byte)Notoriety.Compute(beholder, beheld));
    ...
    public sealed class GQRequest : Packet
    {
        public GQRequest() : base(0xC3)
        {
            ...
            _Stream.Write((int)1);
            _Stream.Write((int)2); // ID
            _Stream.Write((int)3); // Customer ? (this)
            _Stream.Write((int)4); // Customer this (?)
            _Stream.Write((int)0);
            _Stream.Write((short)0);
            _Stream.Write((short)6);
            _Stream.Write((byte)'r');
            _Stream.Write((byte)'e');
            _Stream.Write((byte)'g');
            _Stream.Write((byte)'i');
            _Stream.Write((byte)'o');
            _Stream.Write((byte)'n');
            _Stream.Write((int)7); // Call time in seconds
            _Stream.Write((short)2); // Map (0=fel,1=tram,2=ilsh)
            _Stream.Write((int)8); // X
            _Stream.Write((int)9); // Y
            _Stream.Write((int)10); // Z
            _Stream.Write((int)11); // Volume
            _Stream.Write((int)12); // Rank
            _Stream.Write((int)-1);
            _Stream.Write((int)1); // type
        }
    }
    ...
    public sealed class GQCount : Packet
    {
        ...
        {
            _Stream.Write((short)unk);
            _Stream.Write((int)count);
        }
    }
    ...
    public class ParticleEffect : Packet
    {
        ...
        {
            _Stream.Write((byte)type);
            _Stream.Write((int)from);
            _Stream.Write((int)to);
            _Stream.Write((short)itemID);
            _Stream.Write((short)fromPoint.X);
            _Stream.Write((short)fromPoint.Y);
            _Stream.Write((sbyte)fromPoint.Z);
            _Stream.Write((short)toPoint.X);
            _Stream.Write((short)toPoint.Y);
            _Stream.Write((sbyte)toPoint.Z);
            _Stream.Write((byte)speed);
            _Stream.Write((byte)duration);
            _Stream.Write((byte)0);
            _Stream.Write((byte)0);
            _Stream.Write((bool)fixedDirection);
            _Stream.Write((bool)explode);
            _Stream.Write((int)hue);
            _Stream.Write((int)renderMode);
            _Stream.Write((short)effect);
            _Stream.Write((short)explodeEffect);
            _Stream.Write((short)explodeSound);
            _Stream.Write((int)serial);
            _Stream.Write((byte)layer);
            _Stream.Write((short)unknown);
        }
    ...
    public class ScreenEffect : Packet
    {
        public ScreenEffect(ScreenEffectType type)
            : base(0x70, 28)
        {
            _Stream.Write((byte)0x04);
            _Stream.Fill(8);
            _Stream.Write((short)type);
            _Stream.Fill(16);
        }
    }
    ...
    public sealed class BoltEffect : Packet
    {
        ...
        {
            _Stream.Write((byte)0x01); // type
            _Stream.Write((int)target.Serial);
            _Stream.Write((int)Serial.Zero);
            _Stream.Write((short)0); // itemID
            _Stream.Write((short)target.X);
            _Stream.Write((short)target.Y);
            _Stream.Write((sbyte)target.Z);
            _Stream.Write((short)target.X);
            _Stream.Write((short)target.Y);
            _Stream.Write((sbyte)target.Z);
            _Stream.Write((byte)0); // speed
            _Stream.Write((byte)0); // duration
            _Stream.Write((short)0); // unk
            _Stream.Write(false); // fixed direction
            _Stream.Write(false); // explode
            _Stream.Write((int)hue);
            _Stream.Write((int)0); // render mode
        }
    }
    ...
    public sealed class NewSpellbookContent : Packet
    {
        public NewSpellbookContent(Item item, int graphic, int offset, ulong content) : base(0xBF)
        {
            ...
            _Stream.Write((short)0x1B);
            _Stream.Write((short)0x01);

            _Stream.Write((int)item.Serial);
            _Stream.Write((short)graphic);
            _Stream.Write((short)offset);

            for (int i = 0; i < 8; ++i)
                _Stream.Write((byte)(content >> (i * 8)));
        }
    }
    ...
    public sealed class SpellbookContent : Packet
    {
        public SpellbookContent(int count, int offset, ulong content, Item item) : base(0x3C)
        {
            ...
            for (int i = 0; i < 64; ++i, mask <<= 1)
            {
                if ((content & mask) != 0)
                {
                    _Stream.Write((int)(0x7FFFFFFF - i));
                    _Stream.Write((ushort)0);
                    _Stream.Write((byte)0);
                    _Stream.Write((ushort)(i + offset));
                    _Stream.Write((short)0);
                    _Stream.Write((short)0);
                    _Stream.Write((int)item.Serial);
                    _Stream.Write((short)0);
    ...
    public sealed class ContainerDisplay : Packet
    {
        ...
        {
            _Stream.Write((int)c.Serial);
            _Stream.Write((short)c.GumpID);
        }
    }
    ...
    public sealed class ContainerContentUpdate : Packet
    {
        public ContainerContentUpdate(Item item) : base(0x25, 20)
        {
            ...
            _Stream.Write((int)item.Serial);
            _Stream.Write((ushort)item.ItemID);
            _Stream.Write((byte)0); // signed, itemID offset
            _Stream.Write((ushort)item.Amount);
            _Stream.Write((short)item.X);
            _Stream.Write((short)item.Y);
            _Stream.Write((int)parentSerial);
            _Stream.Write((ushort)(item.QuestItem ? Item.QuestItemHue : item.Hue));
        }
    }
        ...
        public ContainerContent(Mobile beholder, Item beheld) : base(0x3C)
        {
            ...
            for (int i = 0; i < count; ++i)
            {
                ...
                if (!child.Deleted && beholder.CanSee(child))
                {
                    ...
                    _Stream.Write((int)child.Serial);
                    _Stream.Write((ushort)child.ItemID);
                    _Stream.Write((byte)0); // signed, itemID offset
                    _Stream.Write((ushort)child.Amount);
                    _Stream.Write((short)loc.X);
                    _Stream.Write((short)loc.Y);
                    _Stream.Write((int)beheld.Serial);
                    _Stream.Write((ushort)(child.QuestItem ? Item.QuestItemHue : child.Hue));
    ...
    public sealed class Swing : Packet
    {
        ...
        {
            _Stream.Write((byte)flag);
            _Stream.Write((int)attacker.Serial);
            _Stream.Write((int)defender.Serial);
        }
    }
    ...
    public sealed class ServerChange : Packet
    {
        ...
        {
            _Stream.Write((short)m.X);
            _Stream.Write((short)m.Y);
            _Stream.Write((short)m.Z);
            _Stream.Write((byte)0);
            _Stream.Write((short)0);
            _Stream.Write((short)0);
            _Stream.Write((short)map.Width);
            _Stream.Write((short)map.Height);
        }
    }
    ...
    public sealed class SkillUpdate : Packet
    {
        public SkillUpdate(Skills skills) : base(0x3A)
        {
            ...
            _Stream.Write((byte)0x02); // type: absolute, capped
            ...
            for (int i = 0; i < skills.Length; ++i)
            {
                ...
                _Stream.Write((ushort)(s.Info.SkillID + 1));
                _Stream.Write((ushort)uv);
                _Stream.Write((ushort)s.BaseFixedPoint);
                _Stream.Write((byte)s.Lock);
                _Stream.Write((ushort)s.CapFixedPoint);
            }

            _Stream.Write((short)0); // terminate
        }
    }
    ...
    public sealed class SkillChange : Packet
    {
        public SkillChange(Skill skill) : base(0x3A)
        {
            ...
            _Stream.Write((byte)0xDF); // type: delta, capped
            _Stream.Write((ushort)skill.Info.SkillID);
            _Stream.Write((ushort)uv);
            _Stream.Write((ushort)skill.BaseFixedPoint);
            _Stream.Write((byte)skill.Lock);
            _Stream.Write((ushort)skill.CapFixedPoint);
    ...
    public sealed class MessageLocalized : Packet
    {
        ...
        public MessageLocalized(Serial serial, int graphic, MessageType type, int hue, int font, int number, string name, string args) : base(0xC1)
        {
            ...
            _Stream.Write((byte)type);
            _Stream.Write((short)hue);
            _Stream.Write((short)font);
            _Stream.Write((int)number);
            _Stream.WriteAsciiFixed(name, 30);
            _Stream.WriteLittleUniNull(args);
        }
    }
    ...
    public sealed class MobileMoving : Packet
    {
        public MobileMoving(Mobile m, int noto) : base(0x77, 17)
        {
            ...
            _Stream.Write((int)m.Serial);
            _Stream.Write((short)m.Body);
            _Stream.Write((short)loc.X);
            _Stream.Write((short)loc.Y);
            _Stream.Write((sbyte)loc.Z);
            _Stream.Write((byte)m.Direction);
            _Stream.Write((short)hue);
            _Stream.Write((byte)m.GetPacketFlags());
            _Stream.Write((byte)noto);
        }
    }
    ...
    public sealed class MobileMovingOld : Packet
    {
        public MobileMovingOld(Mobile m, int noto) : base(0x77, 17)
        {
            ...
            _Stream.Write((byte)m.Direction);
            _Stream.Write((short)hue);
            _Stream.Write((byte)m.GetOldPacketFlags());
            _Stream.Write((byte)noto);
        }
    }
    ...
    public sealed class MultiTargetReqHS : Packet
    {
        ...
        {
            _Stream.Write((bool)t.AllowGround);
            _Stream.Write((int)t.TargetID);
            _Stream.Write((byte)t.Flags);

            _Stream.Fill();

            _Stream.Seek(18, SeekOrigin.Begin);
            _Stream.Write((short)t.MultiID);
            _Stream.Write((short)t.Offset.X);
            _Stream.Write((short)t.Offset.Y);
            _Stream.Write((short)t.Offset.Z);
    ...
    public sealed class DragEffect : Packet
    {
        public DragEffect(IEntity src, IEntity trg, int itemID, int hue, int amount) : base(0x23, 26)
        {
            ...
            _Stream.Write((short)hue);
            _Stream.Write((short)amount);
            _Stream.Write((int)src.Serial);
            _Stream.Write((short)src.X);
            _Stream.Write((short)src.Y);
            _Stream.Write((sbyte)src.Z);
            _Stream.Write((int)trg.Serial);
            _Stream.Write((short)trg.X);
            _Stream.Write((short)trg.Y);
            _Stream.Write((sbyte)trg.Z);
        }
    }
    ...
    public sealed class DisplayGumpPacked : Packet, IGumpWriter
    {
        ...
        public void Flush()
        {
            ...
            _Stream.Write((int)m_Gump.Serial);
            _Stream.Write((int)m_Gump.TypeID);
            _Stream.Write((int)m_Gump.X);
            _Stream.Write((int)m_Gump.Y);

            // Note: layout MUST be null terminated (don't listen to krrios)
            m_Layout.Write((byte)0);
            WritePacked(m_Layout);

            _Stream.Write((int)m_StringCount);
        ...
        private void WritePacked(PacketWriter src)
        {
            ...
            _Stream.Write((int)(4 + packLength));
            _Stream.Write((int)length);
            _Stream.Write(m_PackBuffer, 0, packLength);
    ...
    public sealed class DisplayGumpFast : Packet, IGumpWriter
    {
        ...
        public DisplayGumpFast(Gump g) : base(0xB0)
        {
            ...
            _Stream.Write((int)g.Serial);
            _Stream.Write((int)g.TypeID);
            _Stream.Write((int)g.X);
            _Stream.Write((int)g.Y);
        ...
        public void AppendLayout(int val)
        {
            ...
            _Stream.Write(m_Buffer, 0, bytes);
        ...
        public void AppendLayoutNS(int val)
        {
            ...
            _Stream.Write(m_Buffer, 1, bytes);
            m_LayoutLength += bytes;
        }
    ...
    public sealed class DisplayGump : Packet
    {
        public DisplayGump(Gump g, string layout, string[] text) : base(0xB0)
        {
            ...
            _Stream.Write((int)g.X);
            _Stream.Write((int)g.Y);
            _Stream.Write((ushort)(layout.Length + 1));
            _Stream.WriteAsciiNull(layout);

            _Stream.Write((ushort)text.Length);
    ...
    public sealed class DisplayPaperdoll : Packet
    {
        public DisplayPaperdoll(Mobile m, string text, bool canLift) : base(0x88, 66)
        {
            ...
            _Stream.Write((int)m.Serial);
            _Stream.WriteAsciiFixed(text, 60);
            _Stream.Write((byte)flags);
        }
    }
    ...
    public sealed class PlaySound : Packet
    {
        ...
        {
            _Stream.Write((byte)1); // flags
            _Stream.Write((short)soundID);
            _Stream.Write((short)0); // volume
            _Stream.Write((short)target.X);
            _Stream.Write((short)target.Y);
            _Stream.Write((short)target.Z);
        }
    }
    ...
    public sealed class ScrollMessage : Packet
    {
        public ScrollMessage(int type, int tip, string text) : base(0xA6)
        {
            ...
            _Stream.Write((byte)type);
            _Stream.Write((int)tip);
            _Stream.Write((ushort)text.Length);
            _Stream.WriteAsciiFixed(text, text.Length);
        }
    }
    ...
    public sealed class CurrentTime : Packet
    {
        public CurrentTime() : base(0x5B, 4)
        {
            ...
            _Stream.Write((byte)now.Hour);
            _Stream.Write((byte)now.Minute);
            _Stream.Write((byte)now.Second);
        }
    }
    ...
    public sealed class MapChange : Packet
    {
        public MapChange(Mobile m) : base(0xBF)
        {
            ...
            _Stream.Write((short)0x08);
            _Stream.Write((byte)(m.Map == null ? 0 : m.Map.MapID));
        }
    }
    ...
    public sealed class SeasonChange : Packet
    {
        ...
        {
            _Stream.Write((byte)season);
            _Stream.Write((bool)playSound);
        }
    }
    ...
    public sealed class SupportedFeatures : Packet
    {
        ...
        public SupportedFeatures(NetState ns) : base(0xB9, ns.ExtendedSupportedFeatures ? 5 : 3)
        {
            ...
            {
                _Stream.Write((uint)flags);
            }
            else
            {
                _Stream.Write((ushort)flags);
            }
        }
    }
    ...
    public sealed class MobileHits : Packet
    {
        ...
        {
            _Stream.Write((int)m.Serial);
            _Stream.Write((short)m.HitsMax);
            _Stream.Write((short)m.Hits);
        }
    }
    ...
    public sealed class MobileHitsN : Packet
    {
        ...
        {
            _Stream.Write((int)m.Serial);
            AttributeNormalizer.Write(_Stream, m.Hits, m.HitsMax);
        }
    }
    ...
    public sealed class MobileMana : Packet
    {
        ...
        {
            _Stream.Write((int)m.Serial);
            _Stream.Write((short)m.ManaMax);
            _Stream.Write((short)m.Mana);
        }
    }
    ...
    public sealed class MobileManaN : Packet
    {
        ...
        {
            _Stream.Write((int)m.Serial);
            AttributeNormalizer.Write(_Stream, m.Mana, m.ManaMax);
        }
    }
    ...
    public sealed class MobileStam : Packet
    {
        ...
        {
            _Stream.Write((int)m.Serial);
            _Stream.Write((short)m.StamMax);
            _Stream.Write((short)m.Stam);
        }
    }
    ...
    public sealed class MobileStamN : Packet
    {
        ...
        {
            _Stream.Write((int)m.Serial);
            AttributeNormalizer.Write(_Stream, m.Stam, m.StamMax);
        }
    }
    ...
    public sealed class PathfindMessage : Packet
    {
        ...
        {
            _Stream.Write((short)p.X);
            _Stream.Write((short)p.Y);
            _Stream.Write((short)p.Z);
        }
    }
    ...
    public sealed class MobileAnimation : Packet
    {
        ...
        {
            _Stream.Write((int)m.Serial);
            _Stream.Write((short)action);
            _Stream.Write((short)frameCount);
            _Stream.Write((short)repeatCount);
            _Stream.Write((bool)!forward); // protocol has really "reverse" but I find this more intuitive
            _Stream.Write((bool)repeat);
            _Stream.Write((byte)delay);
        }
    }
    ...
    public sealed class MobileStatusCompact : Packet
    {
        public MobileStatusCompact(bool canBeRenamed, Mobile m) : base(0x11)
        {
            ...
            AttributeNormalizer.WriteReverse(_Stream, m.Hits, m.HitsMax);

            _Stream.Write(canBeRenamed);

            _Stream.Write((byte)0); // type
        }
    }
    ...
    public sealed class MobileStatusExtended : Packet
    {
        ...
        public MobileStatusExtended(Mobile m, NetState ns) : base(0x11)
        {
            ...
            _Stream.Write(m.CanBeRenamedBy(m));

            _Stream.Write((byte)type);

            _Stream.Write(m.Female);

            _Stream.Write((short)m.Str);
            _Stream.Write((short)m.Dex);
            _Stream.Write((short)m.Int);
            ...
            _Stream.Write((int)m.TotalGold);
            _Stream.Write((short)(Core.AOS ? m.PhysicalResistance : (int)(m.ArmorRating + 0.5)));
            _Stream.Write((short)(Mobile.BodyWeight + m.TotalWeight));

            if (type >= 5)
            {
                _Stream.Write((short)m.MaxWeight);
                _Stream.Write((byte)(m.Race.RaceID + 1));  // Would be 0x00 if it's a non-ML enabled account but...
            }

            _Stream.Write((short)m.StatCap);

            _Stream.Write((byte)m.Followers);
            _Stream.Write((byte)m.FollowersMax);

            if (type >= 4)
            {
                _Stream.Write((short)m.FireResistance); // Fire
                _Stream.Write((short)m.ColdResistance); // Cold
                _Stream.Write((short)m.PoisonResistance); // Poison
                _Stream.Write((short)m.EnergyResistance); // Energy
                _Stream.Write((short)m.Luck); // Luck
                ...
                _Stream.Write((short)min); // Damage min
                _Stream.Write((short)max); // Damage max

                _Stream.Write((int)m.TithingPoints);
            }

            if (type >= 6)
            {
                for (int i = 0; i < 15; ++i)
                    _Stream.Write((short)m.GetAOSStatus(i));
            }
        }
    }
    ...
    public sealed class MobileStatus : Packet
    {
        ...
        public MobileStatus(Mobile beholder, Mobile beheld, NetState ns) : base(0x11)
        {
            ...
            _Stream.Write(beheld.CanBeRenamedBy(beholder));

            _Stream.Write((byte)type);

            if (type > 0)
            {
                _Stream.Write(beheld.Female);

                _Stream.Write((short)beheld.Str);
                _Stream.Write((short)beheld.Dex);
                _Stream.Write((short)beheld.Int);

                WriteAttr(beheld.Stam, beheld.StamMax);
                WriteAttr(beheld.Mana, beheld.ManaMax);

                _Stream.Write((int)beheld.TotalGold);
                _Stream.Write((short)(Core.AOS ? beheld.PhysicalResistance : (int)(beheld.ArmorRating + 0.5)));
                _Stream.Write((short)(Mobile.BodyWeight + beheld.TotalWeight));

                if (type >= 5)
                {
                    _Stream.Write((short)beheld.MaxWeight);
                    _Stream.Write((byte)(beheld.Race.RaceID + 1)); // Would be 0x00 if it's a non-ML enabled account but...
                }

                _Stream.Write((short)beheld.StatCap);

                _Stream.Write((byte)beheld.Followers);
                _Stream.Write((byte)beheld.FollowersMax);

                if (type >= 4)
                {
                    _Stream.Write((short)beheld.FireResistance); // Fire
                    _Stream.Write((short)beheld.ColdResistance); // Cold
                    _Stream.Write((short)beheld.PoisonResistance); // Poison
                    _Stream.Write((short)beheld.EnergyResistance); // Energy
                    _Stream.Write((short)beheld.Luck); // Luck
                    ...
                    _Stream.Write((int)beheld.TithingPoints);
                }

                if (type >= 6)
                {
                    for (int i = 0; i < 15; ++i)
                        _Stream.Write((short)beheld.GetAOSStatus(i));
                }
            }
        }
        ...
        {
            _Stream.Write((short)current);
            _Stream.Write((short)maximum);
        }

        private void WriteAttrNorm(int current, int maximum)
        {
            AttributeNormalizer.WriteReverse(_Stream, current, maximum);
        }
    }
        ...
        public MobileIncoming(Mobile beholder, Mobile beheld) : base(0x78)
        {
            ...
            if (beheld.HairItemID > 0)
            {
                if (m_DupedLayers[(int)Layer.Hair] != m_Version)
                {
                    ...
                    _Stream.Write((int)HairInfo.FakeSerial(beheld));
                    _Stream.Write((ushort)itemID);
                    _Stream.Write((byte)Layer.Hair);
            ...
            if (beheld.FacialHairItemID > 0)
            {
                if (m_DupedLayers[(int)Layer.FacialHair] != m_Version)
                {
                    ...
                    _Stream.Write((int)FacialHairInfo.FakeSerial(beheld));
                    _Stream.Write((ushort)itemID);
                    _Stream.Write((byte)Layer.FacialHair);

                    _Stream.Write((short)hue);
                }
            }

            _Stream.Write((int)0); // terminate
        }
    }
    ...
    public sealed class MobileIncomingOld : Packet
    {
        ...
        public MobileIncomingOld(Mobile beholder, Mobile beheld) : base(0x78)
        {
            ...
            _Stream.Write((byte)beheld.Direction);
            _Stream.Write((short)hue);
            _Stream.Write((byte)beheld.GetOldPacketFlags());
            _Stream.Write((byte)Notoriety.Compute(beholder, beheld));
    ...
    public sealed class UnicodeMessage : Packet
    {
        public UnicodeMessage(Serial serial, int graphic, MessageType type, int hue, int font, string lang, string name, string text) : base(0xAE)
        {
            ...
            _Stream.Write((short)hue);
            _Stream.Write((short)font);
            _Stream.WriteAsciiFixed(lang, 4);
            _Stream.WriteAsciiFixed(name, 30);
            _Stream.WriteBigUniNull(text);
        }
    }
    ...
    public sealed class LoginConfirm : Packet
    {
        public LoginConfirm(Mobile m) : base(0x1B, 37)
        {
            ...
            _Stream.Write((short)0);
            _Stream.Write((short)0);
            _Stream.Write((short)(map == null ? 6144 : map.Width));
            _Stream.Write((short)(map == null ? 4096 : map.Height));
    ...
    public sealed class CharacterListUpdate : Packet
    {
        public CharacterListUpdate(IAccount a) : base(0x86)
        {
            ...
            for (int i = 0; i < count; ++i)
            {
                ...
                if (m != null)
                {
                    _Stream.WriteAsciiFixed(m.Name, 30);
                    _Stream.Fill(30); // password
                }
                else
                {
    ...
    public sealed class CharacterList : Packet
    {
        public CharacterList(IAccount a, CityInfo[] info) : base(0xA9)
        {
            ...
            for (int i = 0; i < count; ++i)
            {
                if (a[i] != null)
                {
                    _Stream.WriteAsciiFixed(a[i].Name, 30);
                    _Stream.Fill(30); // password
                }
                else
                {
            ...
            _Stream.Write((byte)info.Length);
            ...
            for (int i = 0; i < info.Length; ++i)
            {
                ...
                _Stream.Write((byte)i);
                _Stream.WriteAsciiFixed(ci.City, 32);
                _Stream.WriteAsciiFixed(ci.Building, 32);
                _Stream.Write((int)ci.X);
                _Stream.Write((int)ci.Y);
                _Stream.Write((int)ci.Z);
                _Stream.Write((int)ci.Map.MapID);
                _Stream.Write((int)ci.Description);
                _Stream.Write((int)0);
            }
            ...
            _Stream.Write((int)(flags | m_AdditionalFlags)); // Additional Flags
            ...
            if (disabled != 0)
            {
                ...
                _Stream.UnderlyingStream.Flush();

                byte[] hashCode = m_MD5Provider.ComputeHash(_Stream.UnderlyingStream.GetBuffer(), 0, (int)_Stream.UnderlyingStream.Length);
                ...
                for (int i = 0; i < count; ++i)
                {
                    ...
                    _Stream.Seek(35 + (i * 60), SeekOrigin.Begin);
                    _Stream.Write(buffer, 0, buffer.Length);
                }

                _Stream.Seek(35, SeekOrigin.Begin);
                _Stream.Write((int)((long)disabled >> 32));
                _Stream.Write((int)disabled);

                _Stream.Seek(95, SeekOrigin.Begin);
                _Stream.Write(hashCode, 0, hashCode.Length);
            }
        }
    ...
    public sealed class CharacterListOld : Packet
    {
        public CharacterListOld(IAccount a, CityInfo[] info) : base(0xA9)
        {
            ...
            for (int i = 0; i < info.Length; ++i)
            {
                ...
                _Stream.Write((byte)i);
                _Stream.WriteAsciiFixed(ci.City, 31);
                _Stream.WriteAsciiFixed(ci.Building, 31);
            }
            ...
            _Stream.Write((int)(flags | CharacterList.AdditionalFlags)); // Additional Flags
    ...
    public sealed class MessageLocalizedAffix : Packet
    {
        public MessageLocalizedAffix(Serial serial, int graphic, MessageType messageType, int hue, int font, int number, string name, AffixType affixType, string affix, string args) : base(0xCC)
        {
            ...
            _Stream.Write((int)serial);
            _Stream.Write((short)graphic);
            _Stream.Write((byte)messageType);
            _Stream.Write((short)hue);
            _Stream.Write((short)font);
            _Stream.Write((int)number);
            _Stream.Write((byte)affixType);
            _Stream.WriteAsciiFixed(name, 30);
            _Stream.WriteAsciiNull(affix);
            _Stream.WriteBigUniNull(args);
        }
    }
    ...
    public sealed class FollowMessage : Packet
    {
        ...
        {
            _Stream.Write((int)serial1);
            _Stream.Write((int)serial2);
        }
    }
    ...
    public sealed class AccountLoginAck : Packet
    {
        public AccountLoginAck(ServerInfo[] info) : base(0xA8)
        {
            ...
            _Stream.Write((byte)0x5D); // Unknown

            _Stream.Write((ushort)info.Length);

            for (int i = 0; i < info.Length; ++i)
            {
                ServerInfo si = info[i];

                _Stream.Write((ushort)i);
                _Stream.WriteAsciiFixed(si.Name, 32);
                _Stream.Write((byte)si.FullPercent);
                _Stream.Write((sbyte)si.TimeZone);
                _Stream.Write((int)Utility.GetAddressValue(si.Address.Address));
            }
        }
    }
    ...
    public sealed class DisplaySignGump : Packet
    {
        public DisplaySignGump(Serial serial, int gumpID, string unknown, string caption) : base(0x8B)
        {
            ...
            _Stream.Write((int)serial);
            _Stream.Write((short)gumpID);
            _Stream.Write((short)(unknown.Length));
            _Stream.WriteAsciiFixed(unknown, unknown.Length);
            _Stream.Write((short)(caption.Length + 1));
            _Stream.WriteAsciiFixed(caption, caption.Length + 1);
        }
    }
    ...
    public sealed class PlayServerAck : Packet
    {
        ...
        public PlayServerAck(ServerInfo si) : base(0x8C, 11)
        {
            ...
            _Stream.Write((byte)addr);
            _Stream.Write((byte)(addr >> 8));
            _Stream.Write((byte)(addr >> 16));
            _Stream.Write((byte)(addr >> 24));

            _Stream.Write((short)si.Address.Port);
            _Stream.Write((int)m_AuthID);
        }
    }
    ...
    public abstract class Packet
    {
        ...
        protected PacketWriter _Stream;
        ...
        {
            _Stream = PacketWriter.CreateInstance(length);// new PacketWriter( length );
            _Stream.Write((byte)m_PacketID);
            _Stream.Write((short)0);
        }
        ...
        private void InternalCompile(bool compress)
        {
            if (m_Length == 0)
            {
                long streamLen = _Stream.Length;

                _Stream.Seek(1, SeekOrigin.Begin);
                _Stream.Write((ushort)streamLen);
            }
            else if (_Stream.Length != m_Length)
            {
                int diff = (int)_Stream.Length - m_Length;

                Console.WriteLine("Packet: 0x{0:X2}: Bad packet length! ({1}{2} bytes)", m_PacketID, diff >= 0 ? "+" : "", diff);
            }

            MemoryStream ms = _Stream.UnderlyingStream;
            ...
            PacketWriter.ReleaseInstance(_Stream);
            _Stream = null;
        }
    }
}
