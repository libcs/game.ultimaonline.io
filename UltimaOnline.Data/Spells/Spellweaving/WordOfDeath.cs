    ...
    public class WordOfDeathSpell : ArcanistSpell
    {
        ...
        public void Target(Mobile m)
        {
            ...
            else if (CheckHSequence(m))
            {
                ...
                Effects.SendMovingParticles(new Entity(Serial.Zero, loc, m.Map), new Entity(Serial.Zero, m.Location, m.Map), 0xF5F, 1, 0, true, false, 0x251D, 0, 0, EffectLayer.Head, 0, 0x21, 0x3F);
