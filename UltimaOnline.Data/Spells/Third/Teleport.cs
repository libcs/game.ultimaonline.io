...
namespace UltimaOnline.Spells.Third
{
    public class TeleportSpell : MagerySpell
    {
        ...
        public override bool CheckCast()
        {
            ...
            else if (UltimaOnline.Misc.WeightOverloading.IsOverloaded(Caster))
            {
        ...
        public void Target(IPoint3D p)
        {
            ...
            else if (CheckSequence())
            {
                ...
                {
                    if (item is UltimaOnline.Spells.Sixth.ParalyzeFieldSpell.InternalItem || item is UltimaOnline.Spells.Fifth.PoisonFieldSpell.InternalItem || item is UltimaOnline.Spells.Fourth.FireFieldSpell.FireFieldItem)
                        item.OnMoveOver(m);
                }
